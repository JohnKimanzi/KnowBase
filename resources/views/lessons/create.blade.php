                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 d-flex">
                                        <div class=" flex-fill">
                                            ...
                                            <form id="new_lesson" method="POST" action="{{ route('lessons.store') }}" >
                                                @csrf        
                                                <div class="row">
                                                    <div class="col-xl-6 d-flex">
                                                        <div class="card flex-fill">
                                                            <div class="card-header">
                                                                <ul class="personal-info">
                                                                    <li> 
                                                                        <div class="text"><h3>New lesson  </h3></div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <input type ='text' id="lesson_name" rows='3' class="form-control @error('lesson_name') is-invalid @enderror" name="lesson_name" value="{{ old('lesson_name') }}" required autocomplete="lesson_name" autofocus>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <input type ='number' id="study_time" rows='3' class="form-control @error('study_time') is-invalid @enderror" name="study_time" value="{{ old('study_time') }}" required autocomplete="study_time" autofocus>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <input type ='number' id="pass_mark" rows='3' class="form-control @error('pass_mark') is-invalid @enderror" name="pass_mark" value="{{ old('pass_mark') }}" required autocomplete="pass_mark" autofocus>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <textarea id="description"  rows='5' class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description  ') }}" required autocomplete="description " autofocus></textarea>
