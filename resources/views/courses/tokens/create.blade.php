                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 d-flex">
                                    <div class=" flex-fill">
                                        ...
                                        <form id="new_token" method="POST" action="{{ route('tokens.store') }}" >
                                            @csrf        
                                            <div class="row">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" id="token_name"  class="form-control @error('token_name') is-invalid @enderror" name="token_name" value="{{ old('token_name') }}" required autocomplete="token" autofocus>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" id="code"  class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', Str::random(15)) }}"  required autocomplete="code" autofocus>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <textarea id="description" rows='5' class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" required autocomplete="description" autofocus>{{ old('description') }}</textarea>
